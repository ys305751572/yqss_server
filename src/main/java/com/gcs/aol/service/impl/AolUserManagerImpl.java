...
public class AolUserManagerImpl extends GenericManagerImpl<AolUser, AolUserDAO> implements IAolUserManager {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public JSONResponse queryUsersDataList(PageParameters pp, String user_id,String username,String bak4){
...
//			pv.setList(list);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public JSONResponse queryUsersDataList(PageParameters pp, String usersname, String sexType, String mobile, String birthday, String regTimeQ, String regTimeZ, String orgId){
//		PageVO pv = new PageVO();
		EntityManager em = entityManagerFactory.createEntityManager();
		try {
			String innerSql = "select u from ";
