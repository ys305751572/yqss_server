...
Date.prototype.format = function(format){
    ...
    return format;
		...
		<script type="text/javascript">
				...
				var columns = [ {'text':'月份','dataIndex':'month','width':'70px'},
				                {'text':'类型','dataIndex':'type','render' : typeRender,'width':'70px'},
				                {'text':'年华收益','dataIndex':'yearYield','render':yearYieldRender,'width':'70px'},
				                {'text':'额度','dataIndex':'moneyLimit','width':'70px'}
							    ];
				var arrayObj = [];
				var dataTableObj ;
				$(function() {
					dataTableObj  = new czTools.dataTable({"columns":columns,"render":"doctorListDataTable",
												"url":"${contextPath}/management/dod/list",
												"para":arrayObj,
				...
				function yearYieldRender(row) {
					return row.yearYield + "%";
				}
