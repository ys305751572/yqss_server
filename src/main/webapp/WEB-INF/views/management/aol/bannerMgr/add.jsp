...
function doSubmit() {
	...
	$.ajaxFileUpload({
		url : "${contextPath}/management/banner/save",
		type : 'post',
		secureuri : false,
				...
				<form class="form-horizontal" method="post" id="productForm" name="doctorForm" action="" enctype="multipart/form-data">
					...
					<div class="box span12" style="height: auto;">
						<div class="box-header well z-h2">
							<h2><i class="icon-film"></i> 新增/编辑banner图</h2>
							<jsp:include page="/WEB-INF/views/backDiv.jsp" flush="true">
								<jsp:param name="url" value="${contextPath}/management/banner/index"/>
							</jsp:include>
						</div>
							...
							<div class="z-informa2" style="margin-bottom: 10px;">
								<table>
									...
									<tr>
										<td>
											<div class="control-group">
											  <label class="control-label" style="width:60px;" for="title">banner图标题</label>
											  <div class="controls" style="margin-left: 80px;">
											  	  <input type="text" id="title" name="title" value="${banner.title}" style="width:600px;" placeholder="banner图标题" maxlength="1000" check-type="required" required-message="banner图标题"/>
											  </div>
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="control-group">
											  <label class="control-label" style="width:60px;" for="path">商品图片</label>
											  <div class="controls" style="margin-left: 80px;">	
												<img id="picture" src="${banner.path}" style="height: 200px; width: 300px;display: inherit;" border="0"/>
												<input type="file" style="height: 20px; width: 220px"
													name="add_img" id="add_img" />
												  <input type="hidden" id="hpicture" name="picture" value="" />
											  </div>
											</div>
										</td>
									</tr>
