	...
	<div class="row-fluid">
		<div id="content" class="span12">
			<div class="row-fluid z-ulnone">
				<form class="form-horizontal" method="post" id="productForm" name="doctorForm" action="${contextPath}/management/bank/edit" enctype="multipart/form-data">
					<!--box span12 start-->
					<div class="box span12" style="height: auto;">
						<div class="box-header well z-h2">
							<h2><i class="icon-film"></i> 新增/编辑银行</h2>
							<jsp:include page="/WEB-INF/views/backDiv.jsp" flush="true">
								<jsp:param name="url" value="${contextPath}/management/bank/listPage"/>
							</jsp:include>
						</div>
									...
									<tr>
										<td>
											<div class="control-group">
											  <label class="control-label" style="width:60px;" for="title">银行名称</label>
											  <div class="controls" style="margin-left: 80px;">
											  	  <input type="text" id="name" name="name" value="${bank.name}" style="width:600px;" placeholder="请填写银行名称" maxlength="1000" check-type="required" required-message="请输入银行名称"/>
											  </div>
											</div>
										</td>
									</tr>
