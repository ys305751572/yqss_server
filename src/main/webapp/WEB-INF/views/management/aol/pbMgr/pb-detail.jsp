							...
							<div class="box-header well z-h2">
								<div class="controls" style="margin-left: 10px;">
									...
									<jsp:include page="/WEB-INF/views/backDiv.jsp" flush="true">
										<jsp:param name="url" value="${contextPath}/management/pb/adslist"/>
									</jsp:include>
								</div>
							...
							<div class="z-informa2" style="margin-bottom: 10px;">
								<table>
									...
									<tr>
										<td>
											<div class="control-group">
											  <label class="control-label" style="width:60px;" for="price">商品价格</label>
											  <div class="controls" style="margin-left: 80px;">
											  	 ${pb.price }
											  </div>
											</div>
									...
									<tr >
										<td>
											<div class="control-group">
											<label class="control-label"  style="width:60px;" for="productType">借款期数</label>
											<div class="controls" style="margin-left: 80px;">
												${pb.period}
											</div>
										</td>
									...
									<tr>
										<td>
											<div class="control-group">
											  <label class="control-label" style="width:60px;" for="url">用户名</label>
											  <div class="controls" style="margin-left: 80px;">
												  	 ${pb.username}
											  </div>
											</div>
									...
									<tr>
										<td>
											<div class="control-group">
											  <label class="control-label" style="width:60px;" for="url">是否审核通过</label>
											  <div class="controls" style="margin-left: 80px;">
											  		<c:if test="${pb.isList eq 0}">
											  			审核中
											  		</c:if>
											  		<c:if test="${pb.isList eq 1}">
											  			审核通过
											  		</c:if>
